...
class ChatView(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.message_area.setFont(QFont(config.ui.font.family, config.ui.font.normalSize))
        self.message_area.setMinimumHeight(300)  # 减小高度，节省垂直空间
        self.message_area.setMaximumHeight(400)  # 减小最大高度，防止占用过多空间
        ...
        self.message_input.setMinimumHeight(36)  # 增加输入框高度
    ...
    def on_message_received(self, message: Message):
        ...
        format_user.setForeground(QColor("#0D47A1"))  # 更深的蓝色，提高对比度
        format_user.setFontWeight(QFont.Bold)

        format_time = QTextCharFormat()
        format_time.setForeground(QColor("#212121"))  # 更深的灰色，提高对比度
        format_time.setFontItalic(True)

        format_msg = QTextCharFormat()
        format_msg.setForeground(QColor("#000000"))  # 黑色消息文本
